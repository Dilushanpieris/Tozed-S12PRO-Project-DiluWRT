...
# Configure WLAN (SSIDs and Country Code)
uci set wireless.radio0.country='US'
uci set wireless.radio1.country='US'
uci set wireless.radio0.disabled='0'
uci set wireless.radio1.disabled='0'
uci set wireless.default_radio0.ssid='DiluWRT_S12_2.4G/5G'
uci set wireless.default_radio1.ssid='DiluWRT_S12_2.4G/5G'
uci commit wireless
...
# Configure System Hostname, Regional Targets, and Metadata
...
uci set system.@system[0].description='Official Diluwrt Build Optimized For Tozed S12 Pro'
uci set system.@system[0].notes='# Default Root password : dilu1212
 # Cloud Passwall Support is Enabled
